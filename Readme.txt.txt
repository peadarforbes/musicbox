...
updatelist.sh downloads the latest version of the RFID cards and playlists at bootup from github. User can modify the RFID cards and albums, add new ones etc on github. 

All scripts are run at bootup:

/etc/profile runs the following code (appended to the end of the file):
